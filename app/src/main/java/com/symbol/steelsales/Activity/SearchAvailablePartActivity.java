...
public class SearchAvailablePartActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*txtPartSpecName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                new MaterialAlertDialogBuilder(SearchAvailablePartActivity.this)
                        .setTitle("규격을 선택하세요")
                        .setSingleChoiceItems(partSpecNameSequences, selectedIndex, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                selectedIndex = which;
                            }
                        ...
                        .setOnDismissListener(new DialogInterface.OnDismissListener() {
                            ...
                            public void onDismiss(DialogInterface dialog) {
                                ...
                                //listview.setFilterText("SPP BPE");
                                filter = availablePartAdapter.getFilter();//글자가 나타나는 현상때문에 해당 소스로 변경
                                filter.filter(partSpecNameSequences[selectedIndex]);
                                dialog.dismiss();
                            }
                        })
                        .setPositiveButton("확인", new DialogInterface.OnClickListener() {
